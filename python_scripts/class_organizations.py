"""Endpoints for organization collections and resources"""

from flask_restful import Resource

from resource_functions import get_collection, post_new_resource, get_resource, post_update_existing_resource, delete_resource
...
class Organization(Resource):
    ...
    @requires_auth
    def patch(self, current_user, organization_id=None):
    ...
    @requires_auth
    def delete(self, current_user, organization_id=None):
