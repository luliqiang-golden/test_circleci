"""Org Update Use Batch Name Column as Link"""
...
class OrgUpdateUseBatchNameColumnAsLink(ActivityHandler):
    """Org Update Use Batch Name Column as Link"""

    required_args = {'name', 'organization_id', 'use_batch_name_column_as_link'}

    @classmethod
    def do_activity(cls, args, current_user):
        cls.check_required_args(args)

        update_value = {"use_batch_name_column_as_link": args['use_batch_name_column_as_link']}
