"""
consumable_lot_destroy_items - remove consumable items as they are used
"""
...
class ConsumableLotDestroyItems(ActivityHandler):
    """
    Remove consumable items as they are destroyed
    :param from_consumable_lot_id: consumable lot id
    :param from_qty: Destroyed quantity
    :param unit: The existing unit
    """
    ...
    def do_activity(cls, args, current_user):
        ...
        if args['from_qty'] > current_qty:
            ...
            raise ClientBadRequest({
                "code":
                "consumable_lot_destroy_out_of_bound",
                "description":
