...
class OrderItemAddShipment(ActivityHandler):
    """
        Action to sign a shipment to an order item
    ...
    def do_activity(cls, args, current_user):
        ...
        firing_webhooks(organization_id=args.get("organization_id"), event='order_items.updated', event_data=args)
        return {
