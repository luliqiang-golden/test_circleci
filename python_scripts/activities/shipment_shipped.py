...
class ShipmentShipped(ActivityHandler):
    """
        Action to ship the shipment
    ...
    def do_activity(cls, args, current_user):
        ...
        try:
            ...
            firing_webhooks(organization_id=args["organization_id"], event='shipments.updated',
                            event_data=args)
