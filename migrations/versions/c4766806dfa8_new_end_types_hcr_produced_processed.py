"""new-end-types-hcr-produced-processed

Revision ID: c4766806dfa8
Revises: 9477898fe187
Create Date: 2021-06-15 09:04:11.400301
...
revision = 'c4766806dfa8'
down_revision = '9477898fe187'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    connection.execute(
        """
            ...
            BEGIN		
                ...
                -- unpacakged dried cannabis produced, unpackaged pure intermediate produced
                UPDATE health_canada_report
                SET
    ...
    --							AND TO_CHAR(act_adj.timestamp,'YYYY-MM-DD') <= '2021-06-30'
