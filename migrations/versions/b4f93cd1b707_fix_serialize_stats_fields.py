"""fix serialize_stats_fields

Revision ID: b4f93cd1b707
Revises: b19422a872df
Create Date: 2021-09-09 17:18:50.298398
...
revision = 'b4f93cd1b707'
down_revision = 'b19422a872df'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    connection.execute("""
DROP FUNCTION f_serialize_stats_fields(numeric, varchar, varchar, varchar, jsonb, jsonb, varchar, OUT numeric,
   OUT numeric, OUT numeric, OUT numeric, OUT numeric, OUT numeric, OUT numeric,
   OUT numeric, OUT numeric, OUT numeric, OUT numeric, OUT numeric, OUT numeric,
   OUT numeric, OUT numeric, OUT numeric, OUT numeric, OUT numeric, OUT numeric,
   OUT numeric, OUT numeric, OUT numeric, OUT numeric, OUT numeric, OUT varchar);
